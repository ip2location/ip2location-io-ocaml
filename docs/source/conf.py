...
project = 'IP2Location.io OCaml SDK'
...
myst_html_meta = {
    "description": "IP2Location.io OCaml library allows user to query for an enriched data set based on IP address and provides WHOIS lookup api that helps users to obtain domain information.",
    "keywords": "IP2Location, Geolocation, IP location, OCaml, WHOIS, domain, hosted domains",
...
html_title = "IP2Location.io OCaml SDK"
